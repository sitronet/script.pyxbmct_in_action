...
class OriginalSkin(pyxbmct.Skin):
    '''
    original source is :
    @property
...
pyxbmct.addonwindow.skin = OriginalSkin()
...
#class FenetreOne(pyxbmctExtended.AddonFullWindowWT)  # background (skin) without header+title - could be hide ?
#class
class FenetreOne(pyxbmct.AddonFullWindow):
    ...
    def __init__(self,*args, **kwargs):
        ...
        #super(FenetreOne, self).__init__()
    ...
    def geometrie(self):
        ...
        xbmc.log('Size of grid FenetreOne set to : ' + str(self.screenx) + ' x ' + str(self.screeny), xbmc.LOGNOTICE)
        ...
        self.imagedefond = self.image_dir + '/fond-noir.jpg'
        #self.setBackground(self.imagedefond)
    ...
    def putControlElements(self):
        ''' mainly place the menu list and other elements on the screen 

        '''
        row_depart = 3
        col_depart = row_depart
        self.espace_row = NEUF - 5  # Pixel or tiles ?
...
class Fenetre1(pyxbmct.AddonFullWindow):
    ...
    def __init__(self, *args ):
        ...
        super(Fenetre1, self).__init__('Title -> Fenetre 1 ')
...
class Fenetre2(pyxbmct.AddonDialogWindow):
    ...
    def __init__(self, *args ):
        ...
        super(Fenetre2, self).__init__('title -> Fenetre 2 ')
...
class Fenetre5(pyxbmctExtended.BackgroundDialogWindow):
    '''BackgroundFullWindow and BackgroundDialogWindow have not an header
        ...
        BackgroundDialogWindow have a transparent background beyond the window
        so we see the parent Window but inside itself it have a background fix by skin (main_bg_img)
        unlike BlankDialogWindow
        BackgroundDialogWindow, it is an extension of the original pyxbmct librairy
    '''
...
class Fenetre6(pyxbmctExtended.BackgroundFullWindow):
    '''BackgroundFullWindow and BackgroundDialogWindow doesn't have an header
        ...
        so we could not see the parent Window and inside itself it have a background fix by skin  (main_bg_img)
...
class ContextMenuFrameChild(pyxbmct.AddonDialogWindow):
    ...
    def set_info_controls(self):
        ...
        self.label_context_basgauche = pyxbmct.Label('BG. 500 x 400 px')
...
class VolumeFrameChild(pyxbmct.BlankDialogWindow):
    ...
    def __init__(self):
        ...
        # inside this child frame we define a grid : 5 rows X 10 columns
